...
- (void)viewDidLoad {
    ...
    [[UINavigationBar appearance] setTitleTextAttributes:@{NSForegroundColorAttributeName : FirstColor, NSFontAttributeName : kFont(18)}];
    //导航栏背景颜色
...
//
//        if ([vc isKindOfClass:[BHYOrderDetailViewController class]]) {
//
////            //删除确定订单在push栈
////            NSMutableArray <UIViewController *>*viewcontrollers = [NSMutableArray arrayWithArray:self.viewControllers];
////            [viewcontrollers removeObject:vc];
////            self.viewControllers = viewcontrollers;
////            [_screenshotImgs removeObjectAtIndex:_screenshotImgs.count - 3];
//            break;
//        }
//    }
