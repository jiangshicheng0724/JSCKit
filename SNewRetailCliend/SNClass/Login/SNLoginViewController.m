...
- (void)addCodeLoginSubViews{
    ...
    UIView *line = [UIView viewWithBackgroundColor:[RYToolClass getColorWithHexString:@"#DDDDDD"] superView:self.codeLoginBgView];
    ...
    UIView *line1 = [UIView viewWithBackgroundColor:[RYToolClass getColorWithHexString:@"#DDDDDD"] superView:self.codeLoginBgView];
...
- (void)addPwdLoginSubviews{
    ...
    UIView *line = [UIView viewWithBackgroundColor:[RYToolClass getColorWithHexString:@"#DDDDDD"] superView:self.pwdLoginBgView];
    [line mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo((62));
        make.right.mas_equalTo((-30));
        make.top.mas_equalTo((58));
    ...
    UIView *line1 = [UIView viewWithBackgroundColor:[RYToolClass getColorWithHexString:@"#DDDDDD"] superView:self.pwdLoginBgView];
    [line1 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo((62));
        make.right.mas_equalTo((-30));
        make.bottom.mas_equalTo(0);
...
- (void)addLoginChooiceSubviews{
    ...
    UIView *line = [UIView viewWithBackgroundColor:[RYToolClass getColorWithHexString:@"#DDDDDD"] superView:self.loginChooiceBgView];
    [line mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo((30));
        make.right.mas_equalTo((-30));
        make.bottom.mas_equalTo(0);
    ...
    UIView *line1 = [UIView viewWithBackgroundColor:[RYToolClass getColorWithHexString:@"#DDDDDD"] superView:self.loginChooiceBgView];
    [line1 mas_makeConstraints:^(MASConstraintMaker *make) {
    ...
    UIView *indicatorView = [UIView viewWithBackgroundColor:YellowColor superView:self.loginChooiceBgView];
    ...
    [codeLoginBtn bk_whenTapped:^{
        ...
        //        codeLoginBtn.userInteractionEnabled = NO;
        pwdLoginBtn.userInteractionEnabled = YES;
        indicatorView.centerX = codeLoginBtn.centerX;
        self.codeLoginBgView.hidden = NO;
        self.pwdLoginBgView.hidden = YES;
        self->isCode = YES;
    }];
    [pwdLoginBtn bk_whenTapped:^{
        ...
        indicatorView.centerX = pwdLoginBtn.centerX;
...
- (UIView *)loginChooiceBgView{
    if (!_loginChooiceBgView) {
        ...
        _loginChooiceBgView = [UIView viewWithBackgroundColor:WhiteColor superView:self.view];
...
- (UIView *)codeLoginBgView{
    ...
    if (!_codeLoginBgView) {
        ...
        _codeLoginBgView = [UIView viewWithBackgroundColor:WhiteColor superView:self.view];
...
- (UIView *)pwdLoginBgView{
    if (!_pwdLoginBgView) {
        ...
        _pwdLoginBgView = [UIView viewWithBackgroundColor:WhiteColor superView:self.view];
