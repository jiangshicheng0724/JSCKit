...
#define LINEURL         @"http://www.fahuo580.com"
...
// 计算比例
// X坐标
#define KLineX(l) l*kRatioX6
// Y坐标
//#define KLineY(l) l*kRatioY6
#define KLineY(l) l*1
// 字体systemFontOfSize:12 weight:UIFontWeightRegular
#define kFont(x) [UIFont systemFontOfSize:x*kRatioX6 weight:UIFontWeightRegular]

#define kwFont(x) [UIFont systemFontOfSize:x*kRatioX6 weight:UIFontWeightRegular]

#define kkFont(x) [UIFont systemFontOfSize:x*kRatioX6 weight:UIFontWeightBold]
...
#define SafeMaginBottomHeight (kScreenHeight >= 812.0 ? 24 : 10) //适配iphoneX底部
#define SafeMaginToBottomHeight (kScreenHeight >= 812.0 ? 24 : 0) //适配iphoneX底部

#define SafeTopHeight (kScreenHeight >= 812.0 ? 64 : 0) //适配iphoneX底部
#define SafeBottomHeight (kScreenHeight >= 812.0 ? 88 : 0) //适配iphoneX底部
